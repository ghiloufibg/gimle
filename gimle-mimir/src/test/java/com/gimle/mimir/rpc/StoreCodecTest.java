...
class StoreCodecTest {
  ...
  static Stream<StoreRpc> variants() {
    return Stream.of(
        ...
        new StoreRpc.GetDeployment(Optional.empty(), "greeter"),
        new StoreRpc.GetDeploymentGeneration(Optional.empty(), "greeter"),
        new StoreRpc.ListDeployments(),
        new StoreRpc.ListAssignmentsFor(Optional.empty(), "greeter"),
        new StoreRpc.IsQuotaViolating(Optional.empty(), "greeter"),
        ...
        new StoreRpc.GetEffectiveReplicas("Deployment", Optional.empty(), "greeter"),
        new StoreRpc.GetDeploymentLastScale("Deployment", Optional.empty(), "greeter"),
        new StoreRpc.GetDeploymentLastScale("StatefulSet", Optional.of("tenant-1"), "greeter"),
