 ...
 * JobSpec} is still non-terminal (priority-3 design doc §3d) -- mirrors Kubernetes CronJob's own
 * three-value policy exactly, a well-understood reference semantic rather than an invented one.
 */
