 ...
 * exercising the {@code /ingest/metrics/*} and {@code /metrics/*} routes -- mirrors {@code
 * MuninnServerLogsIngestTest}'s own shape, since both ride the identical {@link
 * MuninnDayFileStore}-backed ingest/read plumbing; see {@link AbstractIngestTest} for the shared
 * server/client scaffolding.
 */
class MuninnServerMetricsIngestTest extends AbstractIngestTest {
