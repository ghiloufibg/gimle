 ...
 * exercising the {@code /ingest/traces/*} and {@code /traces/*} routes (design doc Part B/O-13) --
 * mirrors {@code MuninnServerMetricsIngestTest}'s own shape, since both ride the identical {@link
