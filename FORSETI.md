...
| GIMLE-801 | `gimle-andvari-console` | Push artifact dialog derives the coordinate from the jar's own bundled gimle-module.yaml, rather than trusting a typed one | observable | FLEET | ART-1 |
<!-- /forseti:generated -->
