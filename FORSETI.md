...
| GIMLE-797 | `gimle-examples` | A bundled example module reports a real listening port, so Midgard ships a real workload a Service can resolve | observable | FLEET | NET-1 |
<!-- /forseti:generated -->
