...
|---|---:|---|
| Requirements in `requirements-matrix.json` | 799 | The whole denominator before any classification. |
...
| **User-observable** | **532** | The capability set the fleet is measured against. |
| Reached by a fleet scenario | 532 | **100.0%** of the user-observable set — meets the 90% target. |
