...
| GIMLE-788 | `gimle-agent` | Per-worker certificates: node-minted worker identity carrying the worker's tenant | observable | FLEET | NET-6 |
<!-- /forseti:generated -->
