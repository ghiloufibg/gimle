...
|---|---:|---|
| Requirements in `requirements-matrix.json` | 966 | The whole denominator before any classification. |
...
| **User-observable** | **691** | The capability set the fleet is measured against. |
| Reached by a fleet scenario | 665 | **96.2%** of the user-observable set — meets the 90% target. |
