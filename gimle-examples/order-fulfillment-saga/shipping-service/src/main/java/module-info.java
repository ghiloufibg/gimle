 ...
 * these types).
 */
module com.example.orderfulfillment.shipping {
  requires static com.gimle.module;
  requires static org.slf4j;

  // FabricServer (gimle-fabric) reflectively invokes ShippingService methods on the registered
  ...
  // ShippingServiceHooks: ModuleController instantiates this reflectively from outside the
  // module, the same way it does with every long-running module's own ModuleLifecycleHooks.
  exports com.example.orderfulfillment.shipping;
}
