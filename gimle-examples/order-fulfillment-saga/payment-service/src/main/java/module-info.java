 ...
 * these types).
 */
module com.example.orderfulfillment.payment {
  requires static com.gimle.module;
  requires static org.slf4j;

  // FabricServer (gimle-fabric) reflectively invokes PaymentService methods on the registered
  ...
  // PaymentServiceHooks: ModuleController instantiates this reflectively from outside the module,
  // the same way it does with every long-running module's own ModuleLifecycleHooks.
  exports com.example.orderfulfillment.payment;
}
