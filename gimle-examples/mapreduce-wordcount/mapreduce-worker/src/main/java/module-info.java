 ...
 * these types).
 */
module com.example.mapreduce.worker {
  requires static com.gimle.module;
  requires static org.slf4j;

  // FabricServer (gimle-fabric) reflectively invokes MapReduceWorker methods on the registered
  ...
  // WordCountMapWorkerHooks: ModuleController instantiates this reflectively from outside the
  // module, the same way it does with every long-running module's own ModuleLifecycleHooks.
  exports com.example.mapreduce.worker;
}
