 ...
 * these types).
 */
module com.example.nodelocalcache.cache {
  requires static com.gimle.module;
  requires static org.slf4j;

  // FabricServer (gimle-fabric) reflectively invokes FeatureFlagCache methods on the registered
  ...
  // LocalFlagCacheHooks: ModuleController instantiates this reflectively from outside the module,
  // the same way it does with every long-running module's own ModuleLifecycleHooks.
  exports com.example.nodelocalcache.cache;
}
