...
/**
 * The run-to-completion counterpart to {@link ModuleLifecycleHooks}: a Job-kind module's own unit
 * of work, run to completion exactly once rather than living on until told to stop. Declared in
 * {@code gimle-module.yaml} as {@code lifecycle.jobHooks}, a sibling field to {@code
 * lifecycle.hooks}, and instantiated the same reflective, one-interface-a-hook-class
 * can-also-implement way {@link com.gimle.module.probe.LivenessProbe}/{@link
 * com.gimle.module.probe.ReadinessProbe} already are -- not a parallel mechanism.
 *
