...
function ordersPlatform(): Blueprint {
  const nodes: BlueprintNode[] = [
    ...
    },
    {
      ...
      kind: "fafnir",
      position: { x: 80, y: 240 },
      data: { machine: "local", port: 9092, keyFile: "~/.gimle/ivaldi/fafnir.key" },
    },
    {
      id: "r-muninn",
      kind: "muninn",
      position: { x: 300, y: 240 },
      data: { machine: "local", port: 9093 },
    },
    {
      id: "r-andvari",
      kind: "andvari",
      position: { x: 520, y: 240 },
      data: { machine: "local", port: 9094 },
    },
    {
      id: "r-agent1",
      kind: "agent",
      position: { x: 80, y: 340 },
      data: { machine: "local", nodeId: "node-1", gossipPort: 9090, labels: ["ssd"] },
    },
    {
      id: "r-agent2",
      kind: "agent",
      position: { x: 300, y: 340 },
      data: { machine: "local", nodeId: "node-2", gossipPort: 9095, labels: [] },
    },
    {
      id: "t-orders",
      kind: "tenant",
    ...
    },
    {
      ...
      data: { tenantId: "orders-platform", key: "admin.token" },
    },
  ];
  ...
  const edges: BlueprintEdge[] = [
    ...
    ...["a-limits", "a-web", "a-inventory", "a-report", "a-svc", "a-np", "a-cfg", "a-secret"].map(
      (id) => edge("belongsTo", id, "t-orders"),
    ),
  ...
  const nodes: BlueprintNode[] = [
    {
      ...
      kind: "machine",
      position: { x: 40, y: 40 },
      data: { name: "box", host: "127.0.0.1" },
    },
    {
      id: "bs-1",
      kind: "store",
      position: { x: 80, y: 140 },
      data: { machine: "box", raftPort: 9080, clientPort: 9091 },
    },
    {
      id: "bc-1",
      kind: "controlPlane",
      position: { x: 300, y: 140 },
      data: { machine: "box", port: 8080 },
    },
    {
      id: "bc-2",
      kind: "controlPlane",
    ...
    },
    {
      ...
      kind: "fafnir",
      position: { x: 80, y: 240 },
      data: { machine: "box", port: 9092, keyFile: "~/.gimle/fafnir.key" },
    },
    {
      id: "ba-1",
      kind: "agent",
      position: { x: 300, y: 240 },
      data: { machine: "box", nodeId: "node-1", gossipPort: 9090, labels: [] },
    },
    {
      id: "bt-1",
      kind: "tenant",
      ...
      data: {
        id: "demo",
        quota: { maxMemoryBytes: 512 * 1024 * 1024, maxCpuMillicores: 2000, maxInstances: 8 },
      },
    },
    {
      id: "bd-1",
    ...
    },
    {
      ...
      data: {
        ...
        port: 80,
        targetPort: 8080,
        deploymentNames: ["missing-deployment"],
      },
    },
  ];
