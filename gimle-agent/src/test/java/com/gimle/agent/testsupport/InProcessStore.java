 ...
 * shape {@code gimle-andvari}'s/{@code gimle-fafnir}'s/{@code gimle-muninn}'s own test trees
 * already use (not shared via a test-jar since none of these modules depends on another's test
 * sources; small enough to duplicate rather than introduce that coupling for).
 */
