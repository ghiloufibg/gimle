...
/** How the shared retirement gate names Fafnir's asymmetric ring in every rejection it reports. */
const KEY_NOUN = "sealing key";

/**
 * The Seal Keys screen's binding of the shared retire-target pre-flight the Secrets screen also
