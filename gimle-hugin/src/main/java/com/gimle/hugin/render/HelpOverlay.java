...
public final class HelpOverlay {
  ...
  private static final List<String[]> BINDINGS =
      List.of(
          ...
          new String[] {"S", "scan: everything wrong with the cluster, worst first"},
          new String[] {"R", "what your own certificate may do, kind by kind"},
          ...
          new String[] {":tenant ID", "narrow every screen to one tenant; :tenant all undoes it"},
          new String[] {":scan / :can", "the same two screens S and R open, by name"},
