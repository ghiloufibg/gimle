 ...
 * shape {@code gimle-controlplane}'s own test tree already uses (not shared via a test-jar since
 * neither module depends on the other's test sources; small enough to duplicate rather than
 * introduce that coupling for).
 */
