 ...
 *
 * <p>{@code initialDelay} (P2-4) is the manifest's {@code health.initialDelaySeconds}: how long
 * after a module reaches {@code ACTIVE} before its first probe tick fires, independent of the
 * probe's own {@code intervalSeconds}. Absent means the pre-P2-4 behavior -- the first tick fires
 * one interval after {@code ACTIVE}, same as every interval after it.
 */
