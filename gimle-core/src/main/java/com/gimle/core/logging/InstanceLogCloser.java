...
/**
 * Callback surface for closing one instance's sifted log file (design §5), kept separate from
 * {@link InstanceSiftingFileAppender} itself so callers outside {@code gimle-core} (e.g. {@code
